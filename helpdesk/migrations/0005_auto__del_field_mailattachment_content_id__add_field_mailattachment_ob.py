...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MailAttachment.content_id'
        db.delete_column(u'helpdesk_mailattachment', 'content_id')

        # Adding field 'MailAttachment.object_id'
        db.add_column(u'helpdesk_mailattachment', 'object_id',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'MailAttachment.content_id'
        raise RuntimeError("Cannot reverse this migration. 'MailAttachment.content_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'MailAttachment.content_id'
        db.add_column(u'helpdesk_mailattachment', 'content_id',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)

        # Deleting field 'MailAttachment.object_id'
        db.delete_column(u'helpdesk_mailattachment', 'object_id')
