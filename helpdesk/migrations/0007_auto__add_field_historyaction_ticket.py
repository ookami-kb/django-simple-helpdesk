...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoryAction.ticket'
        db.add_column(u'helpdesk_historyaction', 'ticket',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['helpdesk.Ticket']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoryAction.ticket'
        db.delete_column(u'helpdesk_historyaction', 'ticket_id')
