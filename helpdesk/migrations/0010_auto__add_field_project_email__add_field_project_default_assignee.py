...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'helpdesk_project', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='helpdesk@example.com', max_length=75),
                      keep_default=False)

        # Adding field 'Project.default_assignee'
        db.add_column(u'helpdesk_project', 'default_assignee',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'helpdesk_project', 'email')

        # Deleting field 'Project.default_assignee'
        db.delete_column(u'helpdesk_project', 'default_assignee_id')
