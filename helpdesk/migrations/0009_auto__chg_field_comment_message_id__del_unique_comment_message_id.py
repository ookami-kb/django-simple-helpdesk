...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Comment', fields ['message_id']
        db.delete_unique(u'helpdesk_comment', ['message_id'])


        # Changing field 'Comment.message_id'
        db.alter_column(u'helpdesk_comment', 'message_id', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Comment.message_id'
        raise RuntimeError("Cannot reverse this migration. 'Comment.message_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Comment.message_id'
        db.alter_column(u'helpdesk_comment', 'message_id', self.gf('django.db.models.fields.CharField')(max_length=256, unique=True))
        # Adding unique constraint on 'Comment', fields ['message_id']
        db.create_unique(u'helpdesk_comment', ['message_id'])
    ...
    models = {
        ...
        u'helpdesk.ticket': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '256'}),
