...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'helpdesk_comment', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Comment.author'
        db.alter_column(u'helpdesk_comment', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
