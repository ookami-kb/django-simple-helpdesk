...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HelpdeskProfile.send_notifications'
        db.add_column(u'helpdesk_helpdeskprofile', 'send_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Project.send_notifications'
        db.delete_column(u'helpdesk_project', 'send_notifications')


    def backwards(self, orm):
        # Deleting field 'HelpdeskProfile.send_notifications'
        db.delete_column(u'helpdesk_helpdeskprofile', 'send_notifications')

        # Adding field 'Project.send_notifications'
        db.add_column(u'helpdesk_project', 'send_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
